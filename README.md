...
* Версия 7.5 с PDO (ветка master). (**[Скачать](https://bitbucket.org/DESURE/dcms/get/master.zip)**) Доработка существующего функционала, исправление багов. Подготовка к релизу.
* Версия 7.6 (текущая) - Чистка кода
