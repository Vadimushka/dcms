<div id="pages">
    ...
    for ($i = max(2, $page - 8); $i < min($k_page, $page + 10); $i++) {
        if ($i == $page)
            ...
            echo '<a class="gradient_blue border radius padding" href="' . $link . 'page=' . $i . '">' . $i . '</a>';
    }
    echo $page == $k_page ? '<span class="gradient_blue invert border radius padding">' . $k_page . '</span>' : '<a class="gradient_blue border radius padding" href="' . $link . 'page=' . $k_page . '">' . $k_page . '</a>'
    ?>
</div>
