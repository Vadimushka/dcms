<?php /* Smarty version Smarty-3.0.6, created on 2012-09-16 21:45:17
         compiled from "/var/www/dcmssu2462/data/www/dcms.su/sys/themes/itouch/tpl/design.listing.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15427146805056102da760f1-48559311%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '59d6bdec9892b23098517f653ca0747c29a2df5c' => 
    array (
      0 => '/var/www/dcmssu2462/data/www/dcms.su/sys/themes/itouch/tpl/design.listing.tpl',
      1 => 1339315060,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15427146805056102da760f1-48559311',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('post')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['url']){?><a href="<?php echo $_smarty_tpl->getVariable('post')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['url'];?>
"><?php }?>
...
?>
<td class="act"><a href="<?php echo $_smarty_tpl->getVariable('post')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['act'][$_smarty_tpl->getVariable('smarty')->value['section']['z']['index']][1];?>
"><img src="/sys/images/icons/act.<?php echo $_smarty_tpl->getVariable('post')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['act'][$_smarty_tpl->getVariable('smarty')->value['section']['z']['index']][0];?>
.png" alt="<?php echo $_smarty_tpl->getVariable('post')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['act'][$_smarty_tpl->getVariable('smarty')->value['section']['z']['index']][0];?>
" /></a></td>
<?php endfor; endif; ?>
<?php }?>
</tr>
...
<?php if ($_smarty_tpl->getVariable('post')->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['url']){?></a><?php }?>
