<?php /* Smarty version Smarty-3.0.6, created on 2012-09-16 19:14:20
         compiled from "/var/www/dcmssu2462/data/www/dcms.su/sys/themes/web_blue/tpl/design.pages.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3697219515055eccc093312-30184568%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '337179602876716e237761d6becd26499eb4d602' => 
    array (
      0 => '/var/www/dcmssu2462/data/www/dcms.su/sys/themes/web_blue/tpl/design.pages.tpl',
      1 => 1347785725,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3697219515055eccc093312-30184568',
  'function' => 
  array (
  ),
...
page=1">1</a>
<?php }?>
<?php if ($_smarty_tpl->getVariable('page')->value>10){?>
..
<?php }?>
...
?>
<?php if ($_smarty_tpl->getVariable('smarty')->value['section']['page']['iteration']>1&&$_smarty_tpl->getVariable('smarty')->value['section']['page']['iteration']<$_smarty_tpl->getVariable('k_page')->value&&$_smarty_tpl->getVariable('smarty')->value['section']['page']['iteration']<=$_smarty_tpl->getVariable('page')->value+9&&$_smarty_tpl->getVariable('smarty')->value['section']['page']['iteration']>=$_smarty_tpl->getVariable('page')->value-8){?>
...
<?php }?>
<?php endfor; endif; ?>
<?php if ($_smarty_tpl->getVariable('page')->value<$_smarty_tpl->getVariable('k_page')->value-10){?>
..
<?php }?>
